...
body {
  ...
  background-size: 100% 100%;
     ...
     <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<h3 style="color:blue;">Edit user profile</h3>
		...
		<div class="a1-container a1-transparent a1-center">
        	<h6 style="color:white;">CHANGE PROFILE</h6>
        </div>
       <form id="form1" name="form1" method="post" class="a1-container" action="">
         ...
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
             ...
             <tr>
               <td height="35"style="color:white;">PASSWORD</td>
               <td height="35"><span class="form-control">*********</span> <a href="change_pwd.php" class="a1-btn a1-orange">Change password</a> <span class="help-block"</span></td><br>
             </tr>
