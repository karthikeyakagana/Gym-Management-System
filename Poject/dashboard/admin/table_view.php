...
body{
  ...
  background-size: 100% 100%;
    ...
    <body class="page-body  page-fade" onload="collapseSidebar()">
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-4 clearfix hidden-xs">
						...
						<ul class="list-inline links-list pull-right">
							...
							<li v>Welcome <?php echo $_SESSION['full_name']; ?> 
							</li>								
		...
		<h3 style="color:white;">Member Detail</h3>

		<hr />
		
		<b><table class="table table-bordered datatable" id="table-1" border=1 style="color:white;">
			<thead>
				<tr><h2>
					<th style="color:white;">Sl.No</th>
					<th style="color:white;">Membership Expiry</th>
					<th style="color:white;">Member ID</th>
					<th style="color:white;">Name</th>
					<th style="color:white;">Contact</th>
					<th style="color:white;">E-Mail</th>
					<thstyle="color:white;">Gender</th>
					<th style="color:white;">Joining Date</th>
					<th style="color:white;">Action</th></h2>
				</tr>
			</thead>
				<tbody>
