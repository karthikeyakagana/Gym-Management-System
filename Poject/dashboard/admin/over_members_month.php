...
<head>
    ...
    <title>CFG | Member per month</title>
...
body{
  ...
  background-size: 100% 100%;
    ...
    <body class="page-body  page-fade" onload="collapseSidebar();showMember();">
		...
		<h2 style="color:white;">Member Per Month</h2>
...
<form>
	...
	<select name="month" id="smonth">
	    <option value="0"style="color:white;">Select Month</option>
	    <?php
...
<table id="memmonth" border=1 style="color:white;">
